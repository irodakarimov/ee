...
if (isNaN(num1) || isNaN(num2)) {
    ...
    num1Input.style.width = "50px";
    num1Input.style.height = "50px";
    num1Input.style.textAlign = "center";
    num1Input.style.marginTop = "20px";
    ...
    operatorSelect.style.textAlign = "center"
    ...
    num2Input.style.width = "50px";
    num2Input.style.height = "50px";
    num2Input.style.textAlign = "center";
